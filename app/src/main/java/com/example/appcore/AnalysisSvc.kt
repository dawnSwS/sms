...
class AnalysisSvc : Service() {
    ...
    private fun triggerErrorNotification(errorMessage: String, rawData: String, notificationId: Int) {
        try {
            ...
            val notification = Notification.Builder(this, channelId)
                ...
                .setContentTitle("Analysis Service: Async Hostage Held")
                .setContentText("API is out of service. SMS is strictly HELD and will NOT bypass.")
